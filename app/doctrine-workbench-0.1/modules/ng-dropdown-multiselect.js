	...
	angular.module('ng-dropdown-multiselect', [])
      ...
      return {
        ...
        template: function (element, attributes) {
          ...
          template += '<div class="menu-item-status"><span class="glyphicon" data-ng-class="{\'glyphicon-ok\': isChecked(getPropertyForObject(option,settings.idProp)), \'glyphicon-remove\': !isChecked(getPropertyForObject(option,settings.idProp))}"></span></div>';
